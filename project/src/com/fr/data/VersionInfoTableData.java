...
public class VersionInfoTableData extends AbstractTableData {
    ...
    public Object[][] initDatas() {
        ...
        boolean isAppContentMatch = isAppContentMatch();
        ...
        Object[][] arrayOfObject = { 
                ...
                { "Re-system-version", ProductConstants.VERSION },
    ...
    private boolean isVersionNumberMatch(String versionNumberInLic) {
        return ComparatorUtils.equals(ProductConstants.VERSION, versionNumberInLic);
    }
    ...
    private boolean isAppContentMatch() {
    	return true;
    }
